...
To claim the username manually through the WhatsApp Manager, without using the API, see [Claiming the username](/en/positus/getting-started/claiming-username).
</Info>
