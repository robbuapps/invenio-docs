...
*Ao contratar e ativar a sua conta de WhatsApp Business API, nós iremos fornecer uma chave por número e você poderá gerar seus tokens pela plataforma.*


[⬇️ Download da collection Postman — Produção (2026)](/assets/Positus-API-2026.postman_collection.json)
...
*Crie sua conta na sandbox pelo link* [*https://studio.posit.us/*](https://studio.posit.us/) *e gere um token seguindo as instruções da tela.* Navegue no menu "Webhook" e copie a URL POST (ela usa a "Chave").
...
[⬇️ Download da collection Postman — Sandbox (2026)](/assets/Positus-API-Sandbox-2026.postman_collection.json)
