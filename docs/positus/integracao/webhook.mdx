...
<Info>
Se sua URL de Webhook fica atrás de um firewall ou lista de permissões, libere os IPs de origem da Positus. Consulte [IPs para liberação de Webhook](/docs/positus/integracao/ips-webhook).
</Info>
