---
title: API - Studio
description: Consulte em tempo real todos os seus workspaces, números, status e templates cadastrados.
---
...
Veja como gerar o seu token [**clique aqui**](/docs/positus/studio/studio-positus#como-gerar-um-token-para-utilizar-na-api)
</Info>
