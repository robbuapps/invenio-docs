...
| **NUMERO_TELEFONE** | ✅ se e-mail não esttiver preenchido   | Número de telefone com DDD do cliente.                                                       |
| **EMAIL**           | ✅ se telefone não esttiver preenchido | E-mail do cliente.                                                                           |

Exemplo:
```csv
CPF_CNPJ,NUMERO_CONTRATO,NUMERO_TELEFONE,EMAIL
12345678965,456,11981236549,
...
| Campo               | Obrigatório                            | Descrição                                                                                    |
| ------------------- | -------------------------------------- | -------------------------------------------------------------------------------------------- |
| **TIPO_BLOQUEIO**   | ❌                                     | Documento do cliente (para validações ou relatórios).                                        |
| **DATA_SOLICITACAO**| ❌                                     | Código do contrato do cliente.                                                               |
| **DATA_EXPIRACAO**  | ✅ se e-mail não esttiver preenchido   | Número de telefone com DDD do cliente.                                                       |

Exemplo:
```csv
TIPO_BLOQUEIO,NUMERO_CONTRATO,NUMERO_TELEFONE,EMAIL
12345678965,456,11981236549,
98765432156,654,,cliente@dominio.com
```
