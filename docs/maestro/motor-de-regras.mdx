...
#### Limite diários de disparos por contrato

Limite a quantidade de mensagens enviadas por dia para cada contrato. Deixe este campo vazio para não aplicar limite de disparos diários.
