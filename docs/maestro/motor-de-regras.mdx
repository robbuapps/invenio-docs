...
| **CD_TELEFONE_CONTATO**   | ✅ se EMAIL não estiver preenchido     | Número de telefone com DDD do cliente.                                                       |
| **EMAIL**                 | ✅ se CD_TELEFONE_CONTATO não estiver preenchido    | E-mail do cliente.                                                                           |

> ℹ️ É possível fazer combinações misturando os campos acima. **A combinação que não pode ser feita** no mesmo contato é o **"cd_telefone_contato" e "email".**  
> **Exemplo Inválido**
> ```csv
