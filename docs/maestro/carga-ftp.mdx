...
**Criar template**
- Sem TEMPLATE_CODE e EXTERNAL_CODE

**Criar e revisar**
- Template não existe + TEMPLATE_STATUS informado

**Revisar**
- TEMPLATE_CODE informado ou EXTERNAL_CODE já existente
...
- REJEITADO exige REASONS
- REASONS devem existir no sistema
- EXTERNAL_CODE deve ser único
- Se houver erro, nenhuma linha é processada
