...
- **SFTP Robbu (padrão):** a Robbu disponibiliza um servidor SFTP gerenciado, pronto para uso imediato.  
- **SFTP Próprio:** a empresa pode configurar e utilizar seu próprio servidor SFTP, garantindo maior autonomia e controle sobre credenciais e diretórios.
...
![sftp](https://robbublob.blob.core.windows.net/docs/maestro/sftp.png)
...
- O nome do arquivo “FormatoErradoNomeArquivo.csv”  não esta no formato válido. Formato esperado: segmento_canal_templateCode_YYYYMMDD.csv
