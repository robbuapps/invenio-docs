...
| **202 - OK**                  | Mensagem em processamento — Passou pelas validações e foi enfileirada para envio.  |
...
```
- 202 - OK: Indica que a mensagem passou pelas validações do motor de regras e foi enfileirada para ser enviada.
```json
{
