...
description: "Documentação técnica sobre a consulta de templates HSM via API no Invenio."
...
_Imagem 3 – Exemplo de resposta no navegador._
_Imagem 4 – Exemplo de resposta formatada no Postman._
