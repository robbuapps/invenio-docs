...
<Warning>
  O rate limit é avaliado **antes** de qualquer outra validação de negócio (autenticação, criação de pessoa, blacklist, template, envio etc.). Os limites podem ser revistos pela Robbu de acordo com o perfil de uso da integração e as características do canal utilizado.
</Warning>
