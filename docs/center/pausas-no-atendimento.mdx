 ...
 *As pausas serão válidas para todo o ambiente.*
 ...
 *As pausas não encerram automaticamente.* Após o tempo configurado, o sistema sinaliza o atraso com a cor vermelha.

_Imagem 4 – Botão de pausar atendimento + seleção de pausa_

_Imagem 5 – Botão de retornar ao atendimento_
 ...
 *Para visão geral, deixe os filtros em branco.*
