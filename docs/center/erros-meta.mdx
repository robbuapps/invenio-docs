...
description: "Dicionário de erros da API do WhatsApp Business: causas prováveis e como evitar falhas de entrega."
---

Este guia detalha os erros mais comuns retornados pela API da Meta, ajudando a identificar por que uma mensagem não foi entregue e como solucionar o problema.
...
> **Causa provável:**<br/> Esse erro pode ocorrer por diversos motivos, sendo os mais comuns:<br/>
