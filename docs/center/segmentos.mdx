...
<img src="https://robbublob.blob.core.windows.net/docs/nivelconta.png" /> 
...
<img src="https://robbublob.blob.core.windows.net/docs/segmentoconta.png" /> 
...
- O botão de download não é exibido.
- Ao passar o mouse sobre o texto, é exibido o motivo do bloqueio.
- Não é possível visualizar ou reenviar o conteúdo.

---

### Monitoramento (KPI)

Sempre que um arquivo for bloqueado:

- Um KPI é gerado automaticamente.
- O registro contém:
  - ID da mensagem
  - Extensão bloqueada
- O evento é registrado independentemente do canal.

**Título do KPI:**
Arquivo bloqueado automaticamente

- Isso garante rastreabilidade e auditoria dos bloqueios realizados.
<img src="https://robbublob.blob.core.windows.net/docs/bloqueadoauto.png" /> 
