...
<Info>
Si la URL de tu Webhook está detrás de un firewall o lista de permitidos, permite las IPs de origen de Positus. Consulta [IPs para liberación de Webhook](/es/positus/integracion/ips-webhook).
</Info>
