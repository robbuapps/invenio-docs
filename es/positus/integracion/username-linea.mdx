...
Para reivindicar el username manualmente desde el Administrador de WhatsApp, sin usar la API, consulta [Reivindicando el nombre de usuario](/es/positus/primeros-pasos/reivindicar-nombre-de-usuario).
</Info>
